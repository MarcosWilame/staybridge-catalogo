...
export function WhatsAppButton() {
  ...
  return (
    <motion.button
      onClick={handleClick}
      className="group fixed bottom-24 right-4 z-50 rounded-full bg-[var(--whatsapp)] p-3 text-white shadow-2xl shadow-[rgba(37,211,102,0.28)] transition-all duration-300 hover:bg-[var(--whatsapp-hover)] hover:shadow-3xl md:bottom-6 md:right-6 md:p-4"
    ...
    >
      <WhatsAppIcon className="h-7 w-7 transition-transform duration-300 group-hover:rotate-12 md:h-8 md:w-8" />
